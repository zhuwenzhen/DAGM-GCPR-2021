...
%%%%%%%%%%%%%%%%%%%%% Add submission id, track, and title. %%%%%%%%%%%%%%%%%%%%%

% Insert your submission number here
\def\SubNumber{000}

% Choose one track by uncommenting one of the following lines  
\def\GCPRTrack{Regular Track}
% \def\GCPRTrack{Track: Computer vision systems and applications}
% \def\GCPRTrack{Track: Pattern recognition in the life and natural sciences}
% \def\GCPRTrack{Track: Photogrammetry and remote sensing}
% \def\GCPRTrack{Track: Robot vision}
% \def\GCPRTrack{Track: DAGM Young Researcher Forum}

% Replace with your title
\title{Title}
% You can use \thanks for acknowledgment. Do not add any acknowledgment to the draft 
% version that is used for the review process.  
%\title{Title\thanks{XXX}}
